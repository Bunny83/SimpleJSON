...
namespace SimpleJSON
{
	...
	public class JSONNode
	{
		...
		public static string GetJSONEroorContext(string aJSON, int i)
		{
			int startIndex = Math.Max(i - 40, 0);
			int endIndex = Math.Min(i + 40, (int)aJSON.Length);
				...
				switch (aJSON[i])
				{
					...
					case ',':
						...
						else
						{
							if (aJSON[i - 1] == ',')
							{
								throw new Exception("Json format seems invalid at " + aJSON[i] + " Context is : \n" + GetJSONEroorContext(aJSON, i));
							}
						}
						TokenName = "";
						Token = "";
								...
								case 'n':
									{
										...
										throw new Exception("Json format seems invalid at " + currentChar + " Context is : \n" + GetJSONEroorContext(aJSON, i));
									}
								case 'f':
									{
